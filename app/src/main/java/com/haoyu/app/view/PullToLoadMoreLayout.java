...
/**
 * 创建日期：2017/11/29.
 * 描述:横向加载更多（查看更多）RecyclerView
 * 实现方式是不改变RecyclerView本身，定义了一个父控件装载，查看更多和架子更多的view也同样作为该父控件的子控件。有简单的阻尼回弹效果。
 * 作者:xiaoma
 */

public class PullToLoadMoreLayout extends LinearLayout implements ViewTreeObserver.OnGlobalLayoutListener {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if ((isCanPullUp() && scrollX < 0)) {
                    ...
                    if (loadingMoreEnabled && mOnPullToLeftListener != null) {
            ...
            case MotionEvent.ACTION_UP:
                if (isMoved && loadingMoreEnabled && mOnPullToLeftListener != null) {
